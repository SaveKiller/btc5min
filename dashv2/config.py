...
_REQUIRED = ("data_dir", "history_dir", "host", "port", "chart_previous_candles", "default_order_size_usd", "stall_reconnect_sec", "engine_mode")
...
def load_config() -> dict:
    ...
    engine_mode = str(raw["engine_mode"])
    if engine_mode not in ("replay", "live"):
        raise Exception(f"invalid engine_mode: {engine_mode}")
