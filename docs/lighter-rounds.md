...
| `python scripts/study_candle_color_window.py`                                                                      | Studio P(next Up\|ultime W colori) + streak; cerca `W*` su validation (2..150); report `data/reports/candle_color_window.json`; artifact solo se segnale |
